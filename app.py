...
st.title("MathsGPT To Solve Maths Problems")
...
prompt="""
You're a agent tasked for solving users mathemtical question. Logically arrive at the solution and provide a detailed explanation
